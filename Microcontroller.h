...
class Microcontroller
{
  ...
  public:
     ...
     virtual uint8_t readI2CData()             = 0;
     virtual void    sendI2CReStart()          = 0;
     virtual void    UARTInit(uint8_t dataBits, uint8_t parityBit, uint8_t stopBits, float baud, uint8_t speed, uint8_t RT) = 0; //fuction to initialize the UART, takes the amount of data bits (5,6,6,8 or 9 bits), no, even or an odd parity bit, the amound of stop bits (1 or 2) and the baudrate returns the status code
